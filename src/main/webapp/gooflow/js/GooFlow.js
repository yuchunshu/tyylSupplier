...
GooFlow.prototype={
	...
	addNode:function(id,json){
      ...
      if(json.type.indexOf(" mix")>-1){
		...
		this.$nodeDom[id].css({"background-color":GooFlow.prototype.color.node,"border-color":GooFlow.prototype.color.normal_border});
      }
...
//				tmp=this.$lineDom[oldId].attr("id",newId);
				this.$lineDom[oldId].setAttribute("id",newId);
...
//					this.$nodeDom[id].childNodes[1].setAttribute("marker-end","url(#arrow2)");
					...
					$(this.$lineDom[id].childNodes[1]).attr("stroke",GooFlow.prototype.color.mark||"#ff3300");
					$(this.$lineDom[id].childNodes[1]).attr("marker-end","url(#arrow2)");
				}else{
...
//					this.$nodeDom[id].childNodes[1].setAttribute("marker-end","url(#arrow1)");
					...
					$(this.$lineDom[id].childNodes[1]).attr("stroke",GooFlow.prototype.color.line||"#3892D3");
					$(this.$lineDom[id].childNodes[1]).attr("marker-end","url(#arrow1)");
				}
			}else{
...
//				else	this.$nodeDom[id].strokeColor=GooFlow.prototype.color.line||"#3892D3"
				...
				if(mark)	this.$lineDom[id].strokeColor=GooFlow.prototype.color.mark||"#ff3300";
