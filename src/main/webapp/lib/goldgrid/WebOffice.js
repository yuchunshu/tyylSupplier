function WebOffice2015() {
    ...
    this.setShowDialog = function(thisType, exts) {
        ...
        case this.ShowDialog.DialogSaveAs: // 另存为
            this.blnIE() ? this.obj.ShowDialog(thisType) : this.obj.ExecuteScript(thisType + "",
                    "ActiveObject.ShowDialog(" + thisType + ")");
            break; // 打开窗口
        default:
            ;
            break;
    ...
    this.AddCustomMenu = function() {
        ...
        // 创建语言
        /*
         * var menuLang = custommenu.CreatePopupMenu(); custommenu.AppendMenu(menuLang, 22, false, "简体中文");
         * custommenu.AppendMenu(menuLang, 23, false, "繁体中文(TW)"); custommenu.AppendMenu(menuLang, 24, false,
         * "繁体中文(HK)") custommenu.AppendMenu(menuLang, 25, false, "英文"); custommenu.Add(menuLang, "多语言(&N)");
         */
    ...
    this.WebPageCode = function() {
        ...
        this.blnIE() ? this.obj.ActiveDocument.Application.Dialogs(294).Show() : this.ExecuteScript("WebPageCode",
                FunctionString);
    }
    ...
    this.WebOpenBookMarks = function() {
        ...
        this.blnIE() ? this.obj.ActiveDocument.Application.Dialogs(168).Show() : this.ExecuteScript("WebPageCode",
                FunctionString);
    }
    ...
    this.InsertImageByBookMark = function() {
        ...
        this.obj.ActiveDocument.Shapes.Item(1).WrapFormat.Type = 5; // 0:四周型 1：紧密型 2：穿越型环绕 3：浮于文字上方 4：上下型环绕 5：衬于文字下方
        // 6：浮于文字上方
        return true;
    }
    ...
    this.Skin = function(typeColor) {// 设置边框的演示，使得iWebOffice更好看
        ...
        case "purple":
            ...
            this.Status = ("set pink success");
            break;
        case "black":
            this.setColor("black");
            this.Status = ("set black success");
            break;
        case "white":
            this.setColor("white");
            this.Status = ("set black success");
    ...
    this.setColor = function(typeColor) { // 设置边框演示
        ...
        switch (typeColor) {
        case "purple":
            titleBarColor = 0xCC99CC;
            CustomToolbarStartColor = 0xCC99CC;
            menuBarStartColor = 0xCC99CC;
            menuBarButtonStartColor = 0xFFFFFF;
            menuBarButtonEndColor = 0xAD8DAD;
            menuBarButtonFrameColor = 0x663366;
            break;
        case "black":
            titleBarColor = 0x646464;
            CustomToolbarStartColor = 0x646464;
            menuBarStartColor = 0xB7B5B4;
            menuBarButtonStartColor = 0xF2EAF5;
            menuBarButtonEndColor = 0xF2EAF5;
            menuBarButtonFrameColor = 0xF2EAF5;
            break;
        case "white":
            titleBarColor = 0xC6C1BE;
            CustomToolbarStartColor = 0xC6C1BE;
            menuBarStartColor = 0xF5F3F2;
            menuBarButtonStartColor = 0xF2EAF5;
            menuBarButtonEndColor = 0xF2EAF5;
            menuBarButtonFrameColor = 0xF2EAF5;
            break;
        case "blue":
            titleBarColor = 0xD5B69F;
            CustomToolbarStartColor = 0xD5B69F;
            menuBarStartColor = 0xFCF3EF;
            menuBarButtonStartColor = 0xF2EAF5;
            menuBarButtonEndColor = 0xF2EAF5;
            menuBarButtonFrameColor = 0xF2EAF5;
            break;
        case "yellow":
            titleBarColor = 0x00CCFF;
            CustomToolbarStartColor = 0x00CCFF;
            menuBarStartColor = 0x6AB9FF;
            menuBarButtonStartColor = 0xF2EAF5;
            menuBarButtonEndColor = 0xF2EAF5;
            menuBarButtonFrameColor = 0xF2EAF5;
            break;
    ...
    this.SaveAsPdf = function(FilePath) {
        ...
        if ((this.FileType == ".doc") || (this.FileType == ".docx") || (this.FileType == ".wps")) {
            try {
                ...
                this.obj.ActiveDocument.ExportAsFixedFormat(FilePath, 17, false, 0, 0, 1, 1, 0, true, true, 0, true,
                        true, true);
            } catch (e) {
    ...
    this.SaveAsHtml = function(FilePath) {
        if ((this.FileType == ".doc") || (this.FileType == ".docx") || (this.FileType == ".wps")) {
            try {
                var ret = this.obj.ActiveDocument.SaveAs(FilePath, 8, false, "", false, "", false, false, false, false,
                        false, 0);
