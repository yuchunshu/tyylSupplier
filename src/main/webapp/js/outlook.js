$(function() {
    ...
    $('#css3menu a').click(function() {
        ...
        $('.layout-panel-west>.panel-header>.panel-title').html(a);
        /*
         * var a = $('.layout-panel-west>.panel-header>.panel-title').text(); alert(a); alert($(this).attr('title'));
         * a=$(this).attr('title');
         */
...
function addNav(data) {
    ...
    $.each(data, function(i, sm) {
        ...
        $.each(sm.menus, function(j, o) {
            menulist += '<li><div><a ref="' + o.menuid + '" href="javascript:;" rel="' + o.url
                    + '" ><span class="icon ' + o.icon + '" >&nbsp;</span><span class="nav">' + o.menuname
                    + '</span></a></div></li> ';
        });
        menulist += '</ul>';
...
function addTab(subtitle, url, icon) {
    ...
    if (!$('#tabs').tabs('exists', subtitle)) {
        ...
        var _tab = $('#tabs').tabs('getTab', subtitle);
        $('#tabs').tabs('update', {
            tab : _tab,
            options : _opt
        })
