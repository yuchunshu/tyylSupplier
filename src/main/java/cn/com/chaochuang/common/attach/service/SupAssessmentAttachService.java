...
@Service
@Transactional
public class SupAssessmentAttachService extends SimpleUuidCrudRestService<SysAttach> implements UploadFileInfoPersistence {

	@Value(value = "${upload.appid.assess}")
