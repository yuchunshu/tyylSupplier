...
//             
//             try{
//                 analyzer = new WhitespaceAnalyzer(Version.LUCENE_40);//new StandardAnalyzer(Version.LUCENE_40);
...
//             
//             
//             TopDocs top = isearcher.search(query, 100);
...
//	             String name=doc.get("content"); 
//	             TokenStream token=TokenSources.getAnyTokenStream(isearcher.getIndexReader(), sd.doc, "content", analyzer);//获取tokenstream  
