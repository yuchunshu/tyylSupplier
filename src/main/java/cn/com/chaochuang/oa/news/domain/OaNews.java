...
package cn.com.chaochuang.oa.news.domain;
...
import cn.com.chaochuang.oa.news.reference.NewsTypeConverter;
 ...
 * @Description: 新闻管理
 * @author: chunshu
 * @date: 2017年8月11日 上午10:14:10  
 */
@Entity
@AttributeOverrides({ @AttributeOverride(name = "id", column = @Column(name = "news_id")) })
public class OaNews extends StringUuidEntity {
    ...
    /** 新闻分类 */
    @Convert(converter = NewsTypeConverter.class)
