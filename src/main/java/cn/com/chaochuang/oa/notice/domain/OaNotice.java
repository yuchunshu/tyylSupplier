...
package cn.com.chaochuang.oa.notice.domain;
 ...
 */
@Entity
@AttributeOverrides({ @AttributeOverride(name = "id", column = @Column(name = "notice_id")) })
public class OaNotice extends StringUuidEntity {
