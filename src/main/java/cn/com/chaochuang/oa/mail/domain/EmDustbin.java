 ...
 */
@Entity
@AttributeOverrides({ @AttributeOverride(name = "id", column = @Column(name = "del_id")) })
public class EmDustbin extends StringUuidEntity {

    private static final long serialVersionUID = -5966114022943225968L;
