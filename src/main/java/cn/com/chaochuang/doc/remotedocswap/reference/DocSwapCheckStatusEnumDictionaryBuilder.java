/*
 * FileName:    RemoteEnvStatusEnumDictionaryBuilder.java
 * Description:
 ...
 */
@Component
public class DocSwapCheckStatusEnumDictionaryBuilder extends EnumDictionaryBuilder<DocSwapCheckStatus> {
