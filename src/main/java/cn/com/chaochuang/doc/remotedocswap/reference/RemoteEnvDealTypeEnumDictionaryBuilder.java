/*
 * FileName:    RemoteEnvDealTypeEnumDictionaryBuilder.java
 * Description:
 ...
 */
@Component
public class RemoteEnvDealTypeEnumDictionaryBuilder extends EnumDictionaryBuilder<RemoteEnvDealType> {
